...
//class AllBlind : public GameWard
//{
//private:
//public:
//	AllBlind() {};
//	void All_Ward_Blind(WardManager* maneger, int Wradnum);
//	~AllBlind() {};
//};
//
//class AllClear : public GameWard
//{
//private:
//public:
//	AllClear() {};
//	int All_Ward_Clear(WardManager* maneger, int Wradnum);
//	~AllClear() {};
//};
